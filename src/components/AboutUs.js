...
const H2 = styled.h3`
  ...
  margin-bottom: 70px;
`
const RealTiles = styled.section`
  display: flex;
  flex-wrap: wrap;
  width: 100%;
  align-items: stretch;
    ...
    <Section className="row">
      ...
      <RealTiles>
        ...
        >
          ...
          >
            <div className="stacked__box__pad">
              <span className="tag">18 Jan 21</span>
              <h2>August and REA win W3 Gold&nbsp;Award.</h2>
              <div className="stacked__box__cta">
                <p>
                  We're delighted to announce our recent work in partnership
                  with
                  REA Group—for its global corporate site—has won Gold at the
                  14th
                  Annual W3&nbsp;Awards.
                </p>
              </div>
        ...
        >
          ...
          >
            <div className="stacked__box__pad">
              <span className="tag">18 Jan 2020</span>
              <h2>Finding the balance: convention vs creativity in UX
                design.</h2>
              <div className="stacked__box__cta">
                <p>
                  Can convention and creativity co-exist? Rowan weighs up the
                  pros
        ...
        <RealTile background={mercyImg} width="33.3%">
          ...
          >
            <div className="stacked__box__pad">
              <span className="tag">18 Jan 21</span>
              <h2>Mercy Health and a healthy regard for collaborative
                design.</h2>
              <div className="stacked__box__cta">
                <p>
                  Over the course of four months, 20-plus workshops with more
                  than
        ...
        <RealTile background={analyticsImg} width="33.3%">
          ...
          >
            <div className="stacked__box__pad">
              <span className="tag">18 Jan 21</span>
              <h2>How to grow solid return on your web analytics
                investment.</h2>
              <div className="stacked__box__cta">
                <p>
        ...
        <RealTile background={computerImg} width="66.6%">
          ...
          >
            <div className="stacked__box__pad">
              ...
              <div className="stacked__box__cta">
                <p>
                  As valuable as they are, Google Analytics metrics can
                  sometimes
        ...
        <RealTile background={legislationImg} width="33.3%">
          ...
          >
            <div className="stacked__box__pad">
              ...
              <div className="stacked__box__cta">
                <p>
                  If you’re an agency, business owner, marketer, or just dabble
                  in
